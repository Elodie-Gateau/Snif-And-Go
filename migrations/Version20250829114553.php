 ...
 */
final class Version20250829114553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, trail_id INT DEFAULT NULL, walk_id INT DEFAULT NULL, date DATETIME NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_14B78418A76ED395 (user_id), INDEX IDX_14B7841889B51C5B (trail_id), INDEX IDX_14B784185EEE1B48 (walk_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
